 ...
 * @LastEditTime : 2020-01-03 18:44:30
 * @FilePath: \leigod_admin_front\src\utils\GVerify.js
 */
...
GVerify.prototype = {
    ...
    _init: function() {
      ...
      canvas.onclick = function(){
        if (typeof this.options.clickEvent === 'function') {
          this.options.clickEvent(this.refresh);
        } else {
          this.refresh()
        }
      }
    ...
    refresh: function(code = "") {
      ...
      if(this.options.type == "blend") { //判断验证码类型
        ...
        txtArr = code ? code.split() : this.options.numArr;
        console.log(txtArr);
      } else {
      ...
      /**绘制干扰点**/
      for(let j = 0; j < this.options.width/4; j++) {
